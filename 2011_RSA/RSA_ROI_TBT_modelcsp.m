...
subdir=fullfile(dir,YearID,database{a,2},'fmri/stats_spm12/FC/stats_spm12_swcar');
    ...
    mask='/brain/iCAN/home/tianyanqiu/SPM12_scripts/RSA/CHSFC/ROI_new/CHS_2x2_LAMG_6mm_-22-10-10.nii'; %roi path, single
...
%   ROI(i,1)=sub;
    ...
    ROI(i,2)=sub(a,2);
        ...
        for j=1:15; %number of trails except UCS
            n=j+2;
           % ROI(i,n)=corr(data(:,1),data(:,j)); %CSp1-CSp2,CSp1-CSp3.CSp1-CSp4.....
            ROI(i,n)=corr(data(:,j),data(:,j+15)); %CSp1-CSm1,CSp2-CSm2.CSp3-CSm3.....
        end
...
%     end
  ...
  save('RSA_ROI_2x2_LAMG_6mm_-22-10-10_0s_RSA_meanUCS_CSp_CSm','ROI')
