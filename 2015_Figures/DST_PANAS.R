...
# import data
library(readxl)
a <- read_excel("/Users/tianrachel/Desktop/FC_Final/Data/FC_final_181201/2015/2015_PANAS_positive.xls")
...
p<- ggplot(means, aes(x=t, y=mean, group=group_DXM2_Pla1,col=group)) + 
  ...
  scale_x_continuous(breaks=1:18, labels=c("9:00","10:00", "22:00","7:00","7:15","7:30","8:00","11:00","14:00","15:00/before","16:00/after", "22:00","7:00","7:15","7:30","8:00","11:00","16:00"))
#  scale_x_continuous(breaks=1:15, labels=c("S1", "S2", "S3","S4","S5","S6","S7","S8","S9","S10", "S11","S12","S13","S14","S15"))

p

ggsave("2015_PANAS_positive.eps", plot = last_plot(), device = "eps", path = "/Users/tianrachel/Desktop/FC_Final/Data/FC_final_181201/2015/",
