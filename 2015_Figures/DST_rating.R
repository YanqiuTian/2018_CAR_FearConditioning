...
# Create Line Chart
# import data
a <- read_excel("/Users/tianrachel/Desktop/CHS_Final/CHS_SCR_CSp_CSm_R.xlsx")
#View(a)
library(ggplot2)
library(plyr)
library(reshape2)
...
ggsave("CHS_SCR_CSp_CSm.eps", plot = last_plot(), device = "eps", path = "/Users/tianrachel/Desktop/CHS_Final/",
