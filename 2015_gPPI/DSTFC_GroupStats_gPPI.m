...
% -----------------------------------------------------------------------
datadir1 = '/brain/iCAN/home/tianyanqiu/DST/Results_individualStats/FC_individualstats_0s_new_type_E_L';                 % 
datadir2 = 'fmri/stats_spm8/FC/stats_spm8_swcar_gPPI/PPI_DST_CHS_comm_UCS_RAMG';     % gPPI 
[~,subid,~] = xlsread('/brain/iCAN/home/tianyanqiu/SPM12_scripts/gPPI/DSTFC/DSTFC_group.xlsx',1,'B:B');   % 
...
for i = 1:25
    yearfolder = ['20' subid{i}(1:2)];
    g1c1{i,1} = fullfile(datadir1, yearfolder, subid{i}, datadir2, ['con_PPI_CSpuE_CSmE_' subid{i} '.img,1']);   % high CSpE-CSmE
    g1c2{i,1} = fullfile(datadir1, yearfolder, subid{i}, datadir2, ['con_PPI_CSpuL_CSmL_' subid{i} '.img,1']);   % high CSpL-CSmL
%    g1c3{i,1} = fullfile(datadir1, yearfolder, subid{i}, datadir2, ['con_PPI_2vs0_'  subid{i} '.img,1']);   % L 2vs0
end
for i = 1:32
    yearfolder = ['20' subid{i+25}(1:2)];
    g2c1{i,1} = fullfile(datadir1, yearfolder, subid{i+25}, datadir2, ['con_PPI_CSpuE_CSmE_' subid{i+25} '.img,1']);   % low CSpE-CSmE
    g2c2{i,1} = fullfile(datadir1, yearfolder, subid{i+25}, datadir2, ['con_PPI_CSpuL_CSmL_' subid{i+25} '.img,1']);   % low CSpL-CSmL
...
spm_jobman('initcfg');
clear matlabbatch;
matlabbatch{1}.spm.stats.factorial_design.dir = {'/brain/iCAN/home/tianyanqiu/DST/Result_GroupStats/DSTFC_GroupStats_gPPI_FF_groupxstage_PPI_DST_CHS_comm_UCS_RAMG'};
